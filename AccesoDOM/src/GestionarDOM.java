...
public class GestionarDOM {
    ...
    public int abrir_XML_DOM(File fichero)
    {
        ...
        try{
            ...
            //Ingnora los espacios en blanco. Si no se hace esto entonces los espacios en blanco aparecen como nodos.
    ...
    public int guardarDOMcomoFILE()
    {
        ...
        File archivo_xml = new File("D:\\EstudiosJessica\\Linkia4\\workspace\\AccesoDOM\\Ficheros","salida.xml");
